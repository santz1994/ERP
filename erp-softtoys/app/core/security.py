...
ROLE_HIERARCHY = {
    "admin": ["admin", "ppic_manager", "spv_cutting", "spv_sewing", "spv_finishing",
              "admin_cutting", "admin_sewing", "admin_finishing",
              "qc_inspector", "warehouse_admin", "purchasing", "security"],
    "ppic_manager": ["ppic_manager", "admin_cutting", "admin_sewing",
                     "qc_inspector", "warehouse_admin"],
    "spv_cutting": ["spv_cutting", "admin_cutting"],
    "spv_sewing": ["spv_sewing", "admin_sewing"],
    "spv_finishing": ["spv_finishing", "admin_finishing"],
    "admin_cutting": ["admin_cutting"],
    "admin_sewing": ["admin_sewing"],
    "admin_finishing": ["admin_finishing"],
