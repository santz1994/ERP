...
def format_wib(dt: Optional[datetime], format: str = "%Y-%m-%d %H:%M:%S WIB") -> str:
    """
...
def get_shift(dt: Optional[datetime] = None) -> str:
    """
...
def get_work_week(dt: Optional[datetime] = None) -> int:
    """
...
def get_delivery_week(dt: Optional[datetime] = None, weeks_ahead: int = 4) -> int:
    """
...
def start_of_day_wib(dt: Optional[datetime] = None) -> datetime:
    """
...
def end_of_day_wib(dt: Optional[datetime] = None) -> datetime:
    """
