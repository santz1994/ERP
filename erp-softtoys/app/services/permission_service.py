...
class PermissionService:
    ...
    def _map_permission_code_to_role_permissions(
        ...
        action_mapping = {
            ...
            'view_schedule': 'VIEW',
            'view_reports': 'VIEW',
            'view_production': 'VIEW',
            'view_inventory': 'VIEW',
            'view_qc': 'VIEW',
            'view_financial': 'VIEW',
            'view_checkpoints': 'VIEW',
            'view_shipments': 'VIEW',
            'view_requests': 'VIEW',
            'view_po': 'VIEW',
            'view_wip': 'VIEW',
            'view_system_info': 'VIEW',
            ...
            'approve_adjustment': 'APPROVE',
            'approve_request': 'APPROVE',
            'approve_result': 'APPROVE',
            'lab_test': 'APPROVE',
            'handle_shortage': 'APPROVE',

            # ── EXECUTE ────────────────────────────────────────────
            'execute': 'EXECUTE',
            'complete_operation': 'EXECUTE',
            'transfer_to_next': 'EXECUTE',
            'accept_transfer': 'EXECUTE',
            'process_stage': 'EXECUTE',
            'inline_qc': 'EXECUTE',
            'sort_by_destination': 'EXECUTE',
            'pack_product': 'EXECUTE',
            'label_carton': 'EXECUTE',
            'line_clearance': 'EXECUTE',
            'perform_stuffing': 'EXECUTE',
            'stock_in': 'EXECUTE',
            'stock_out': 'EXECUTE',
            'transfer': 'EXECUTE',
            'ship': 'EXECUTE',
            'fulfill_request': 'EXECUTE',
        }
